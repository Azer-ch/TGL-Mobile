...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        GlobalScope.launch {
            val result = backendApi.getLeagues()
            if (result.isSuccessful) {
                ...
                for(i in leagues.indices){
                    runOnUiThread {
                        ...
                        layoutParam = ConstraintLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,ViewGroup.LayoutParams.WRAP_CONTENT)
                        layoutParam.setMargins(
                        ...
                        layoutParam = noMatchesTextView.layoutParams as ConstraintLayout.LayoutParams
